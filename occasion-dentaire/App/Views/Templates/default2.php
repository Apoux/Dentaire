    ...
    <nav class="navbar navbar-default" style="margin-top: 20px">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= PATH ?>/home/index">OcassionDentaire</a>
            </div>
                    ...
                    <?php if(\App\Model\PersonneRepository::logged()): ?>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?= PATH ?>/user/livraison">Modifier/Ajouter Votre Adresse de Livraison</a> </li>
                                <li><a href="<?= PATH ?>/user/modifpass">Modifier son mot de passe</a> </li>
                            </ul>
                        </li>
                    <?php endif ?>
